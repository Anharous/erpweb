          ...
          <section id="sms" className="section">
            ...
            <form onSubmit={handleSmsSubmit} className='communication_form'>
              ...
              <textarea
                ...
                required
              />
              <button className="email_button" type="submit">Send SMS</button>
            </form>
          </section>
        );
      case 'email':
          ...
          <section id="email" className="section">
            ...
            <form onSubmit={handleEmailSubmit}>
              ...
              <input
                ...
                required
              /> <br />
              <label htmlFor="emailSubject">Subject:</label> <br />
              <input
                type="text"
                id="emailSubject"
                value={emailSubject}
              ...
              <textarea
                ...
                required
              /> <br />
              <button className="email_button" type="submit">Send Email</button>
            </form>
          </section>
        );
      case 'chat':
          ...
          <section id="chat" className="section">
            ...
            <form onSubmit={handleChatSubmit}>
              <input
                ...
                required
              /> <br />
              <button className='email_button' type="submit">Send</button>
            </form>
          </section>
        );
      case 'notice-board':
        return (
          <section id="notice-board" className="section">
            ...
            <form className="textarea" onSubmit={handleNoticeSubmit}>
              <label htmlFor="noticeMessage">New Notice:</label> <br />
              <textarea 
                id="noticeMessage"
                value={noticeMessage}
                ...
                required
              /> <br />
              <button className="email_button" type="submit">Post Notice</button>
            </form>
          </section>
        );
      default:
